...
extension UIImage {
	...
	/// Original author: Björn Sållarp. Used with permission.
    ...
    public func roundedCornerImage(cornerSize: UInt, borderSize: UInt) -> UIImage {
        ...
        let ovalRect = CGRectMake(border, border
			, image.size.width - border * 2
			, image.size.height - border * 2)
		...
		// the clipping path will make anything outside the rounded rect transparent
	...
	/// Original author: Björn Sållarp. Used with permission.
	/// See: http://blog.sallarp.com/iphone-uiimage-round-corners/
	private func addRoundedRectToPath(rect: CGRect
